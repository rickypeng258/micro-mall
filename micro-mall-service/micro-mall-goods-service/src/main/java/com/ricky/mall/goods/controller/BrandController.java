package com.ricky.mall.goods.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.ricky.mall.goods.model.Brand;
import com.ricky.mall.goods.service.BrandService;
import com.ricky.mall.util.RespResult;
...
public class BrandController {
    ...
    @GetMapping("/detail")
    public RespResult<Brand> queryBrandById(@RequestParam("id")int id) {
        return RespResult.ok(brandService.queryById(id));
    }
}
